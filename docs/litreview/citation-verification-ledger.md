...
| 2507.08627 | Wong et al. 2025 — NL in the middle: code translation with IRs (submitted paper's bibliography) | `text-latent-code-autoencoder` §4 (submission record) | Danielle-supplied | TLC | |
