...
| (no ID) | AlphaEvolve (2025) — FunSearch follow-up, RL fine-tuned mutation operator | `prompt-optimization-landscape` (2026-08-24 LLM-as-optimizer entry) | agent-supplied (Perplexity, LLM-as-optimizer convo) | TLC-opt | |
