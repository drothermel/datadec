...
| [irt-literature.md](irt-literature.md) | IRT for NLP benchmarks (Lalor; Rodriguez; tinyBenchmarks; metabench); what structure in the model axis adds; local-independence and binary-vs-margin cautions |
